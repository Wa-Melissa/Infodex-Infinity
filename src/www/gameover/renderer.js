...
const success_photos = ["ali_ayadi-content.jpeg","cedric_wemmert-content.jpg", "cedric_wemmert-securite.png"]; // List of photos to show when winning
...
const success_text = ["Tu as fais un travail excellent, c'est bien.","Tu as vu, c'était pas si difficile !", "Je savais que tu en étais capable, c'est top !"]; // List of messages to show when winning 
